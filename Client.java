...
public class Client extends JFrame implements ActionListener{
    ...
    Client(){
        ...
        //profile icon
        ImageIcon image4 = new ImageIcon(ClassLoader.getSystemResource("com/company/Icons/2.png"));
        ...
        //name of the user
        JLabel label3 = new JLabel("Stefan");
        ...
        label5.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                //System.exit(0);
                JFrame f = new JFrame();
                //JOptionPane.showMessageDialog(f,"Clear chat?","Alert",JOptionPane.YES_OPTION);
